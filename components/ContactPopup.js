      ...
      <div>
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-2 p-8">
              ...
              <Input variant="outlined" type="email" label="Email address" color="teal" required  containerProps={{className: ""}}/>
              <Select variant="outlined" label="Program you're interested in" color="teal"  containerProps={{className: ""}} required>
              ...
              <Textarea variant="outlined" label="Tell us about your qualification & experience" color="teal" containerProps={{className: ""}}/>
