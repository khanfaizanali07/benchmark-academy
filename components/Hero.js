...
export default function Hero() {
  return (
    ...
    >
      ...
      <div className="relative mx-auto grid max-w-7xl gap-16 px-6 pb-20 pt-14 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:px-8 lg:pb-28 lg:pt-20">
        <div>
          ...
          <h1 className="text-balance mt-6 font-display text-[2.6rem] font-semibold leading-[1.08] text-ink sm:text-6xl">
